...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.LeaveItemHolder> {
    ...
    public void setStatus(LeaveItemHolder holder, LeaveItem item) {
        if (item.getDeptHr() == null)
            holder.depthr1.setColorFilter(context.getResources().getColor(R.color.grey));
        else if (item.getDeptHr().equals("Approved"))
        ...
        if (item.getDeptHr1() == null)
            holder.depthr2.setColorFilter(context.getResources().getColor(R.color.grey));
        else if (item.getDeptHr1().equals("Approved"))
            holder.depthr2.setColorFilter(context.getResources().getColor(R.color.green));
        else if (item.getDeptHr1().equals("Rejected"))
            holder.depthr1.setColorFilter(context.getResources().getColor(R.color.red));


        if (item.getTeamLead() == null)
            holder.teamlead.setColorFilter(context.getResources().getColor(R.color.grey));
        else if (item.getTeamLead().equals("Approved"))
            holder.teamlead.setColorFilter(context.getResources().getColor(R.color.green));
        else if (item.getTeamLead().equals("Rejected"))
            holder.depthr1.setColorFilter(context.getResources().getColor(R.color.red));


        if (item.getTeamMember() == null)
            holder.teammember.setColorFilter(context.getResources().getColor(R.color.grey));
        else if (item.getTeamMember().equals("Approved"))
