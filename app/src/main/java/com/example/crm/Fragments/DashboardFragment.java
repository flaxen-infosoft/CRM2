...
import com.example.crm.HRManagement.ReportingActivity;
import com.example.crm.LeaveManagement.LeaveManagementActivity;
import com.example.crm.R;
import com.example.crm.SalesManagement.LeaveApplicationActivity;
...
public class DashboardFragment extends Fragment {
    ...
    CardView employee_cardView, leave_card, crm_card, candidate_card, sales, applyforleave, reports;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        reports = v.findViewById(R.id.reporting);
        ...
        reports.setOnClickListener(view -> {
            startActivity(new Intent(getContext(), ReportingActivity.class));
        });
        ...
        applyforleave.setOnClickListener(v1 -> {
            Intent intent = new Intent(getContext(), LeaveApplicationActivity.class);
            startActivity(intent);
        });
